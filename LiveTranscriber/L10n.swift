...
enum L10n {
    ...
    enum Settings {
        ...
        static let onlineOpenAI = L10n.resource("settings.online_openai", defaultValue: "Online OpenAI", comment: "Settings toggle title for enabling online OpenAI transcription options.")
        static let onlineOpenAIDescription = L10n.resource("settings.online_openai.description", defaultValue: "Show OpenAI transcription options. When enabled, manually selected recording audio can be sent directly from this iPhone to OpenAI.", comment: "Settings toggle description for enabling online OpenAI transcription options.")
        ...
        static let noDeveloperServers = L10n.resource("settings.privacy.no_developer_servers", defaultValue: "No developer-operated servers, third-party analytics, ads, or tracking are used. Optional Local Whisper model and Core ML encoder downloads connect to Hugging Face only when you start those downloads.", comment: "Privacy explanation.")
