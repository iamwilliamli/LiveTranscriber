...
enum L10n {
    ...
    enum Onboarding {
        ...
        static let recordingsDetail = L10n.resource("onboarding.feature.recordings.detail", defaultValue: "Import audio, retranscribe with Apple Speech or local MOSS multi-speaker, translate transcripts, and add tags or summaries.", comment: "Onboarding feature description for recordings.")
        ...
        static let privacyDetail = L10n.resource("onboarding.feature.privacy.detail", defaultValue: "Speech, files, and summaries stay on this device unless you explicitly enable an online option for a saved recording.", comment: "Onboarding feature description for privacy.")
        ...
        static let mossModelTitle = L10n.resource("onboarding.setup.moss_model", defaultValue: "Local MOSS Model", comment: "Onboarding local MOSS model title.")
        static let recommended = L10n.resource("onboarding.setup.recommended", defaultValue: "Recommended", comment: "Badge marking the recommended onboarding download.")
        static let downloadMOSSFormat = L10n.resource("onboarding.setup.download_moss.format", defaultValue: "Download Recommended MOSS Model (%@)", comment: "Onboarding recommended MOSS download button. Parameter: model download size.")
        ...
        static let heroSplashCaption = L10n.resource("onboarding.hero_splash.caption", defaultValue: "Live captions, saved audio, offline MOSS multi-speaker, and private transcript tools in one place.", comment: "Onboarding splash hero caption.")
        ...
        static let heroChipMOSS = L10n.resource("onboarding.hero_chip.moss", defaultValue: "MOSS ready", comment: "Onboarding hero status chip for local MOSS.")
        ...
        static let carouselMOSSTitle = L10n.resource("onboarding.carousel.moss.title", defaultValue: "Local MOSS", comment: "Onboarding splash carousel card title for local MOSS.")
        static let carouselMOSSDetail = L10n.resource("onboarding.carousel.moss.detail", defaultValue: "Offline multi-speaker transcription", comment: "Onboarding splash carousel card detail for local MOSS.")
        ...
        static let carouselPrivateDetail = L10n.resource("onboarding.carousel.private.detail", defaultValue: "Keep work on this device", comment: "Onboarding splash carousel card detail for privacy.")
    ...
    enum Settings {
        ...
        static let audioEventConfidenceThreshold = L10n.resource("settings.audio_event_confidence_threshold", defaultValue: "Audio Event Confidence Threshold", comment: "Developer option title for the minimum displayed audio event confidence.")
        static let audioEventConfidenceThresholdDescription = L10n.resource("settings.audio_event_confidence_threshold.description", defaultValue: "Only show detected audio events above this confidence in lists and playback.", comment: "Developer option description for the minimum displayed audio event confidence.")
        ...
        static let noDeveloperServers = L10n.resource("settings.privacy.no_developer_servers", defaultValue: "No developer-operated servers, third-party analytics, ads, or tracking are used. Optional cloud actions connect directly from this device to the selected provider.", comment: "Privacy explanation.")
    ...
    enum Dashboard {
        static let prompt = L10n.resource("dashboard.prompt", defaultValue: "What would you like to remember today?", comment: "Prompt above the idle recording dashboard.")
        static let ready = L10n.resource("dashboard.ready", defaultValue: "Ready to Record", comment: "Idle recording dashboard status.")
        static let startHint = L10n.resource("dashboard.start_hint", defaultValue: "Tap to record with live transcription", comment: "Short detail below the idle recording action.")
        static let thisWeekInVoice = L10n.resource("dashboard.this_week_in_voice", defaultValue: "This Week in Voice", comment: "Title above the weekly recording activity chart.")
        static let weeklyRecap = L10n.resource("dashboard.weekly_recap", defaultValue: "Weekly Recap", comment: "Title and action for the weekly recording recap.")
        static let recordingsMetric = L10n.resource("dashboard.metric.recordings", defaultValue: "Recordings", comment: "Dashboard metric label for recording count.")
        static let durationMetric = L10n.resource("dashboard.metric.duration", defaultValue: "Duration", comment: "Dashboard metric label for total recording duration.")
        static let topicsMetric = L10n.resource("dashboard.metric.topics", defaultValue: "Topics", comment: "Dashboard metric label for unique topics.")
        static let recordingsCountFormat = L10n.resource("dashboard.recordings_count.format", defaultValue: "%d recordings", comment: "Dashboard metric. Parameter: recording count.")
        static let topicsCountFormat = L10n.resource("dashboard.topics_count.format", defaultValue: "%d topics", comment: "Dashboard metric. Parameter: unique topic count.")
        static let voiceFootprints = L10n.resource("dashboard.voice_footprints", defaultValue: "Voice Footprints", comment: "Dashboard title for the collection of places where recordings were made.")
        static let placesCollectedFormat = L10n.resource("dashboard.places_collected.format", defaultValue: "%d places collected", comment: "Dashboard place collection count. Parameter: unique location count.")
        static let firstPlaceHint = L10n.resource("dashboard.first_place_hint", defaultValue: "Add a location when saving to collect your first voice stamp.", comment: "Dashboard hint shown before any recording locations have been collected.")
        static let pinnedPlace = L10n.resource("dashboard.pinned_place", defaultValue: "Pinned Place", comment: "Fallback name for a collected recording location without a resolved city.")
        static let continueListening = L10n.resource("dashboard.continue_listening", defaultValue: "Continue Listening", comment: "Dashboard action to resume a recent recording.")
        static let latestRecording = L10n.resource("dashboard.latest_recording", defaultValue: "Latest Recording", comment: "Dashboard fallback label when there is no unfinished playback history.")
        static let remainingFormat = L10n.resource("dashboard.remaining.format", defaultValue: "%@ left", comment: "Remaining playback duration. Parameter: localized compact duration.")
        static let mostDiscussed = L10n.resource("dashboard.most_discussed", defaultValue: "You talked most about", comment: "Weekly recap insight label.")
        static let noTopics = L10n.resource("dashboard.no_topics", defaultValue: "Your themes will appear here", comment: "Weekly recap fallback when recordings have no topics.")
        static let worthReplaying = L10n.resource("dashboard.worth_replaying", defaultValue: "Worth Replaying", comment: "Weekly recap recording recommendation title.")
        static let pendingOrganizationFormat = L10n.resource("dashboard.pending_organization.format", defaultValue: "%d recordings to organize", comment: "Weekly recap pending organization count. Parameter: uncategorized recording count.")
        static let organizeUncategorized = L10n.resource("dashboard.organize_uncategorized", defaultValue: "Organize Uncategorized Recordings", comment: "Weekly recap action opening the recordings library.")
        static let openDetails = L10n.resource("dashboard.open_details", defaultValue: "Open detailed statistics", comment: "Accessibility hint and action for opening a dashboard metric.")
        static let thisWeek = L10n.resource("dashboard.insight.this_week", defaultValue: "This week", comment: "Caption for a current-week dashboard statistic.")
        static let allTime = L10n.resource("dashboard.insight.all_time", defaultValue: "All Time", comment: "Dashboard statistic label for all recorded history.")
        static let allTimeCollection = L10n.resource("dashboard.insight.all_time_collection", defaultValue: "Your all-time collection", comment: "Caption for the full voice-footprint collection.")
        static let activeDays = L10n.resource("dashboard.insight.active_days", defaultValue: "Active Days", comment: "Dashboard statistic label for days containing a recording.")
        static let withLocation = L10n.resource("dashboard.insight.with_location", defaultValue: "Located", comment: "Dashboard statistic label for recordings that include location.")
        static let averageSession = L10n.resource("dashboard.insight.average_session", defaultValue: "Average", comment: "Dashboard statistic label for average recording duration.")
        static let longestSession = L10n.resource("dashboard.insight.longest_session", defaultValue: "Longest", comment: "Dashboard statistic label for the longest recording.")
        static let recordingRhythm = L10n.resource("dashboard.insight.recording_rhythm", defaultValue: "Recording Rhythm", comment: "Title for the weekly recording-count chart.")
        static let listeningRhythm = L10n.resource("dashboard.insight.listening_rhythm", defaultValue: "Time in Voice", comment: "Title for the weekly recording-duration chart.")
        static let recentRecordings = L10n.resource("dashboard.insight.recent_recordings", defaultValue: "Recent Recordings", comment: "Title for recent recordings in dashboard details.")
        static let timeByTopic = L10n.resource("dashboard.insight.time_by_topic", defaultValue: "Time by Topic", comment: "Title for the ranked topic-duration visualization.")
        static let placesMetric = L10n.resource("dashboard.insight.places", defaultValue: "Places", comment: "Dashboard statistic label for unique collected places.")
        static let voiceStampCollection = L10n.resource("dashboard.insight.voice_stamp_collection", defaultValue: "Voice Stamp Collection", comment: "Title for the ranked collection of recording places.")
        static let collectionMap = L10n.resource("dashboard.insight.collection_map", defaultValue: "Voice footprint collection map", comment: "Accessibility label for the voice-footprint map.")
        static let moreStatisticsHint = L10n.resource("dashboard.insight.more_statistics_hint", defaultValue: "More detail will appear as your recording collection grows.", comment: "Dashboard statistics empty-state detail.")
    }

    enum ScreenAudio {
        static let title = L10n.resource("screen_audio.title", defaultValue: "Screen Audio", comment: "Title for the iOS screen-audio transcription mode.")
        static let inputSource = L10n.resource("screen_audio.input_source", defaultValue: "Audio Input", comment: "Label for choosing the live transcription audio input source.")
        static let microphone = L10n.resource("screen_audio.input.microphone", defaultValue: "Microphone", comment: "Microphone input source option.")
        static let screenAudio = L10n.resource("screen_audio.input.screen_audio", defaultValue: "Screen Audio", comment: "System or other-app audio input source option.")
        static let compatibilityBackend = L10n.resource("screen_audio.backend.compatibility", defaultValue: "iOS 26 Compatibility", comment: "ReplayKit screen-audio backend display name.")
        static let nativeBackend = L10n.resource("screen_audio.backend.native", defaultValue: "iOS 27 Native", comment: "ScreenCaptureKit screen-audio backend display name.")
        static let startBroadcast = L10n.resource("screen_audio.action.start_broadcast", defaultValue: "Start System Broadcast", comment: "Action label for the ReplayKit system broadcast picker.")
        ...
        static let waitingForTranslation = L10n.resource("screen_audio.caption.waiting_for_translation", defaultValue: "Waiting for translation…", comment: "Caption placeholder before a translation is available.")
        static let statusReady = L10n.resource("screen_audio.status.ready", defaultValue: "Ready", comment: "Screen-audio session idle status.")
        static let statusApproval = L10n.resource("screen_audio.status.approval", defaultValue: "Waiting for Approval", comment: "Screen-audio session status while the system picker is open.")
        static let statusWaiting = L10n.resource("screen_audio.status.waiting", defaultValue: "Waiting for Audio", comment: "Screen-audio status before another app emits audio.")
        static let statusCapturing = L10n.resource("screen_audio.status.capturing", defaultValue: "Capturing", comment: "Screen-audio active capture status.")
        static let statusPaused = L10n.resource("screen_audio.status.paused", defaultValue: "Broadcast Paused", comment: "Screen-audio paused status.")
        static let statusStopping = L10n.resource("screen_audio.status.stopping", defaultValue: "Stopping", comment: "Screen-audio stopping status.")
        static let statusFailed = L10n.resource("screen_audio.status.failed", defaultValue: "Capture Failed", comment: "Screen-audio failed status.")
        static let heartbeatNow = L10n.resource("screen_audio.heartbeat.now", defaultValue: "Audio link active", comment: "Screen-audio heartbeat status when recently updated.")
        static let heartbeatFormat = L10n.resource("screen_audio.heartbeat.format", defaultValue: "Last audio link: %@", comment: "Screen-audio heartbeat timestamp. Parameter: formatted timestamp.")
        static let noHeartbeat = L10n.resource("screen_audio.heartbeat.none", defaultValue: "No audio link yet", comment: "Screen-audio status before receiving a heartbeat.")
        static let couldNotPrepare = L10n.resource("screen_audio.error.prepare", defaultValue: "Could not prepare screen-audio transcription.", comment: "Error shown when the shared transcription pipeline cannot start.")
        static let noAudioCaptured = L10n.resource("screen_audio.error.no_audio", defaultValue: "No screen audio was captured. Start the system broadcast and play unprotected audio in the shared app.", comment: "Error shown when screen-audio capture receives no valid audio.")
        static let appGroupUnavailable = L10n.resource("screen_audio.error.app_group", defaultValue: "The shared screen-audio container is unavailable. Check the App Group capability and signing profile.", comment: "Error shown when the ReplayKit App Group container is unavailable.")
        static let unsupported = L10n.resource("screen_audio.error.unsupported", defaultValue: "This screen-audio backend is unavailable on this iOS version.", comment: "Error shown when a screen-audio backend is unavailable.")
        static let invalidChunk = L10n.resource("screen_audio.error.invalid_chunk", defaultValue: "A screen-audio chunk could not be decoded.", comment: "Error shown for a corrupt shared PCM chunk.")
        static let captureUnavailable = L10n.resource("screen_audio.error.capture_unavailable", defaultValue: "System content sharing is unavailable right now.", comment: "Error shown when the system content sharing picker is unavailable.")
    ...
    enum LocalWhisper {
        ...
        static let modelDownloadedDetailFormat = L10n.resource("local_whisper.model.downloaded_detail.format", defaultValue: "%@ is downloaded on this device (%@).", comment: "Local Whisper downloaded model detail. Parameters: model filename, file size.")
        ...
        static let coreMLEncoderDownloadedDetailFormat = L10n.resource("local_whisper.coreml_encoder.downloaded_detail.format", defaultValue: "%@ Core ML encoder is downloaded on this device (%@).", comment: "Core ML encoder downloaded detail. Parameters: model name, installed size.")
    ...
    enum Qwen3ASR {
        ...
        static let modelDownloadedDetailFormat = L10n.resource("qwen3_asr.model.downloaded_detail.format", defaultValue: "The model is stored on this device (%@).", comment: "Qwen3-ASR downloaded model detail. Parameter: installed size.")
    ...
    enum MOSSLocal {
        ...
        static let modelDownloadedDetailFormat = L10n.resource("moss_local.model.downloaded_detail.format", defaultValue: "The multi-speaker model is stored on this device (%@).", comment: "Local MOSS downloaded model detail. Parameter: installed size.")
        ...
        static let decoderSectionTitle = L10n.resource("moss_local.decoder.section_title", defaultValue: "Decoder Processing", comment: "Settings section title for MOSS Decoder segmentation.")
        static let decoderSegmentDuration = L10n.resource("moss_local.decoder.segment_duration", defaultValue: "Decoder Segment Length", comment: "Settings row title for the amount of audio handled by each MOSS Decoder call.")
        static let decoderSegmentDurationSecondsFormat = L10n.resource("moss_local.decoder.segment_duration.seconds.format", defaultValue: "%d sec", comment: "MOSS Decoder segment duration in seconds. Parameter: number of seconds.")
        static let decoderRecommendedChoiceFormat = L10n.resource("moss_local.decoder.recommended_choice.format", defaultValue: "%@ · Recommended", comment: "MOSS Decoder duration choice marked as recommended. Parameter: duration.")
        static let decoderRecommendationFormat = L10n.resource("moss_local.decoder.recommendation.format", defaultValue: "Recommended for this device: %@ (%@ memory).", comment: "Device-specific MOSS Decoder duration recommendation. Parameters: recommended duration, physical memory.")
        static let decoderUseRecommendationFormat = L10n.resource("moss_local.decoder.use_recommendation.format", defaultValue: "Use Recommended (%@)", comment: "Button that applies the device-specific MOSS Decoder recommendation. Parameter: duration.")
        static let decoderAboveRecommendationFormat = L10n.resource("moss_local.decoder.above_recommendation.format", defaultValue: "%@ is longer than recommended for this device. It may improve speaker continuity, but can increase peak memory use or stop processing.", comment: "Warning shown when the selected MOSS Decoder duration exceeds the device recommendation. Parameter: selected duration.")
        static let decoderSegmentDurationDescription = L10n.resource("moss_local.decoder.segment_duration.description", defaultValue: "Controls how much audio each MOSS Decoder call handles. The Whisper Encoder still processes 30-second windows. Longer segments may improve speaker continuity, but increase peak memory and the time between progress updates. Changes apply to new transcriptions.", comment: "Explanation of the MOSS Decoder segment duration setting and its memory tradeoff.")
        static let decoderMaximumOutputTokens = L10n.resource("moss_local.decoder.maximum_output_tokens", defaultValue: "Maximum Output Tokens", comment: "Settings row title for the maximum number of tokens generated by each MOSS Decoder call.")
        static let decoderMaximumOutputTokensFormat = L10n.resource("moss_local.decoder.maximum_output_tokens.format", defaultValue: "%d tokens", comment: "MOSS Decoder maximum output token count. Parameter: number of tokens.")
        static let decoderMaximumOutputTokensDescription = L10n.resource("moss_local.decoder.maximum_output_tokens.description", defaultValue: "Limits the output generated for each Decoder segment. Increase it when long or dense speech is cut off; higher values can take longer and use more memory. Changes apply to new transcriptions.", comment: "Explanation of the MOSS Decoder maximum output token setting and its performance tradeoff.")
    ...
    enum Import {
        ...
        static let invalidAudioFile = L10n.resource("import.error.invalid_audio_file", defaultValue: "The selected audio file is incomplete or uses an unsupported encoding. Try exporting it as M4A or MP3, then import it again.", comment: "Error shown when an imported audio file cannot be validated or normalized for playback.")
    ...
    enum Recordings {
        ...
        static let today = L10n.resource("recordings.date_group.today", defaultValue: "Today", comment: "Recordings list section containing recordings from today.")
        static let yesterday = L10n.resource("recordings.date_group.yesterday", defaultValue: "Yesterday", comment: "Recordings list section containing recordings from yesterday.")
        static let thisWeek = L10n.resource("recordings.date_group.this_week", defaultValue: "This Week", comment: "Recordings list section containing earlier recordings from the current week.")
        static let earlier = L10n.resource("recordings.date_group.earlier", defaultValue: "Earlier", comment: "Recordings list section containing older recordings.")
        ...
        static let downloadingRecordingFromICloud = L10n.resource("recordings.playback.file_status.downloading", defaultValue: "Downloading recording from iCloud…", comment: "Playback status while downloading recording audio from iCloud.")
        static let iCloudFileStatusFailedFormat = L10n.resource("recordings.playback.icloud_status_failed.format", defaultValue: "Could not check the iCloud file: %@", comment: "Error checking iCloud recording metadata. Parameter: error description.")
        static let iCloudDownloadFailedFormat = L10n.resource("recordings.playback.icloud_download_failed.format", defaultValue: "Could not download the recording from iCloud: %@", comment: "Error downloading a recording from iCloud. Parameter: error description.")
        static let iCloudDownloadTimedOut = L10n.resource("recordings.playback.icloud_download_timed_out", defaultValue: "The iCloud download is taking too long. Check your connection and try again.", comment: "Error shown when an iCloud recording download does not finish in time.")
        ...
        static let skipSilence = L10n.resource("recordings.playback.skip_silence", defaultValue: "Skip Silence", comment: "Accessibility label for the playback control that skips extended silence.")
        static let transcript = L10n.resource("recordings.transcript", defaultValue: "Transcript", comment: "Transcript section title.")
        static let followTranscript = L10n.resource("recordings.transcript.sync_current", defaultValue: "Follow Transcript", comment: "Accessibility label for the playback toggle that keeps the current transcript line visible.")
        ...
        static let modifyCategory = L10n.resource("recordings.category.modify", defaultValue: "Modify Category", comment: "Action and sheet title to edit a recording category's name, icon, and icon color.")
        static let categoryIcon = L10n.resource("recordings.category.icon", defaultValue: "Icon", comment: "Section title and accessibility label for choosing a category icon.")
        static let categoryIconColor = L10n.resource("recordings.category.icon_color", defaultValue: "Icon Color", comment: "Color picker title for a category icon.")
    ...
    enum GeminiCloud {
        ...
        static let apiKeyDescription = L10n.resource("gemini_cloud.api_key.description", defaultValue: "The key is stored in Keychain and used directly by this device to connect to Google's Gemini API.", comment: "Gemini BYOK storage explanation.")
        ...
        static let disabledError = L10n.resource("gemini_cloud.error.disabled", defaultValue: "Turn on Gemini Cloud in Settings > Transcription > Gemini Cloud first.", comment: "Gemini disabled error.")
        static let missingAPIKey = L10n.resource("gemini_cloud.error.missing_api_key", defaultValue: "Add a Gemini API key in Settings > Transcription > Gemini Cloud first.", comment: "Gemini missing API key error.")
    ...
    enum LocalSummary {
        ...
        static let availableDetail = L10n.resource(
            ...
            defaultValue: "Apple Intelligence is unavailable, but Qwen3 summaries can run on this device with embedded llama.cpp.",
        ...
        static let modelDownloadedDetailFormat = L10n.resource(
            ...
            defaultValue: "%@ is downloaded on this device (%@).",
        ...
        static let runtimePending = L10n.resource(
            ...
            defaultValue: "Qwen3 summaries run on this device with embedded llama.cpp after the model is downloaded.",
